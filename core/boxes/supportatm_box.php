 ...
 */
class supportatmbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "supportatm@supportatm";
    public $boxlabel;
    public $depends = array("supportatm");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/supportatm/class/supportatm.class.php";
